      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              No R2 buckets configured in wrangler.toml
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
          ...
          {selectedObject && objectMeta ? (
            <div className="flex-1 flex flex-col">
              <div className="p-4 border-b flex items-center justify-between">
                <div>
                  <h3 className="font-medium font-mono text-xs">{selectedObject}</h3>
                  <p className="text-xs text-muted-foreground mt-1">
                    {formatBytes(objectMeta.size)} • Uploaded{" "}
              ...
              <div className="flex-1 p-4 overflow-auto">
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="p-4 rounded-lg bg-muted font-mono text-xs space-y-1">
                      ...
                      <div>
                        ...
                        {objectMeta.httpMetadata?.contentType ||
                          "application/octet-stream"}
                      </div>
                      <div>
                        <span className="text-muted-foreground">Size:</span>{" "}
                        {formatBytes(objectMeta.size)}
                      </div>
                      <div>
                  ...
                  {objectMeta.customMetadata &&
                    Object.keys(objectMeta.customMetadata).length > 0 && (
                      <div>
                        <h4 className="text-xs font-medium mb-2">Custom Metadata</h4>
                        <div className="p-4 rounded-lg bg-muted font-mono text-xs space-y-1">
                          {Object.entries(objectMeta.customMetadata).map(
                            ([key, value]) => (
                              <div key={key}>
