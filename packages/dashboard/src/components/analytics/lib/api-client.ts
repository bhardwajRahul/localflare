...
// Always uses /api/analytics — proxied to Cloudflare's API by:
//   - Production: dashboard worker (worker/index.ts)
//   - Local dev: Vite rewrites to /__localflare/analytics → localflare API worker
